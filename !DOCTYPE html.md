...
<head>  
    ...
    <!-- ลิงก์ Google Font สำหรับ Kanit --><link href="https://fonts.googleapis.com/css2?family=Kanit:wght@400;600;700&display=swap" rel="stylesheet">  
...
<body class="flex items-center justify-center min-h-screen p-4">  
    ...
    <!-- Preloader (หน้าจอโหลด) --><div id="preloader" class="fixed inset-0 flex flex-col items-center justify-center bg-[#fef3c7] z-50">  
        <!-- โลโก้คาแรคเตอร์สำหรับ Preloader --><img src="https://i.imgur.com/1Dz9aE5.png" alt="โลโก้ร้านย่างหมึกกำลังโหลด" class="w-48 h-auto max-w-[50vw]"  
